...
public class NBUTSpider extends Spider
{
	...
	public void crawl() throws Exception
	{
		...
		try
		{
			...
			html = Tools.getHtml(getMethod, null).replaceAll("(?i)(src|href)\\s*=\\s*(['\"]?)\\s*(?!\\s*['\"]?\\s*http)", "$1=$2http://cdn.ac.nbutoj.com/")
					.replaceAll("cdn\\.ac\\.nbutoj\\.com/+", "cdn.ac.nbutoj.com/").replace("<pre>无</pre>", "");
		} finally
		{
		...
		description.setDescription(Tools.regFind(html,
				"<li class=\"contents\" id=\"description\">([\\s\\S]*?)</li>\\s*<li class=\"titles\" id=\"input-title\">"));
		...
		description.setSampleInput(Tools.regFind(html,
				"<li class=\"contents\" id=\"sampleinput\">([\\s\\S]*?)</li>\\s*<li class=\"titles\" id=\"sampleoutput-title\">"));
		description.setSampleOutput(Tools.regFind(html,
				"<li class=\"contents\" id=\"sampleoutput\">([\\s\\S]*?)</li>\\s*<li class=\"titles\" id=\"hint-title\">"));
		description.setHint(Tools.regFind(html, "<li class=\"contents\" id=\"hint\">([\\s\\S]*?)</li>\\s*<li class=\"titles\" id=\"source-title\">"));
		problem.setSource(Tools.regFind(html, "<li class=\"contents\" id=\"source\">([\\s\\S]*?)</li>\\s*<li class=\"titles\" id=\"operation-title\">")
