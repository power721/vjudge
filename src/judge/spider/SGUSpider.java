	...
	public void crawl() throws Exception
	{
		...
		if (html.contains("<title> SSU Online Contester"))
		{
			description.setDescription(Tools.regFind(html,
					"output: standard </div><br />([\\s\\S]*?)<br /><br /><div align=\"left\" style=\"margin-top:1em;\"><b>Input</b>"));
			...
			description.setOutput(Tools.regFind(html,
					"<b>Output</b></div>([\\s\\S]*?)<br /><br /><div align=\"left\" style=\"margin-top:1em;\"><b>Example\\(s\\)</b>"));
			description.setSampleInput(Tools.regFind(html,
					"<b>Example\\(s\\)</b></div>([\\s\\S]*?)<br /><br />(<div align=\"left\" style=\"margin-top:1em;\"><b>Note</b>|</div><hr />)"));
		...
		} else if (html.contains("<title>Saratov State University"))
		{
			...
			description.setSampleInput(Tools
					.regFind(html, "<b>Sample test\\(s\\)</b></div>([\\s\\S]*?)(<div align = left><br><b>Note</b>|<div align = right>)"));
